...
var Page = /*#__PURE__*/function (_EventEmitter) {
  _inheritsLoose(Page, _EventEmitter);

  function Page(browser, options) {
    var _options$name;
    ...
    _this._root = null;
    _this._name = (_options$name = options.name) != null ? _options$name : "Page-" + nanoid.nanoid(6);
    return _this;
  }
  ...
  _proto.open = /*#__PURE__*/function () {
    var _open = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(path, options) {
      var url$1, res;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              this._page = _context.sent;

            case 4:
              url$1 = new url.URL(path, this._options.baseUrl);
              _context.next = 7;
              return this._page["goto"](url$1.href, options);
  ...
  _proto.trimPage = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              pageSource = _context2.sent;
              $ = cheerio.load(pageSource); // get the root element that we are going to include/exclude tags from

              root = $((_schema$rootElement = schema.rootElement) != null ? _schema$rootElement : "html");
    ...
    function trimPage(_x3) {
      return _trimPage.apply(this, arguments);
    }

    return trimPage;
  }();

  _proto.saveAs = /*#__PURE__*/function () {
    var _saveAs = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(filename, path$1) {
      var html;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 11:
              ...
              _context3.next = 15;
              return mkdirp(path$1);

            case 15:
              _context3.next = 17;
              return promises.writeFile(path.join(path$1, filename), html);
...
exports.Page = Page;
//# sourceMappingURL=crwl.cjs.development.js.map
